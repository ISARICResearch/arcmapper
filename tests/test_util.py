...
from arcmapper.util import read_data, read_csv_with_encoding_detection, parse_redcap_response, read_upload_data
...
def test_read_upload_data():
    ...
    expected = pd.DataFrame({'variable': ['subjid', 'gen'], 'description': ['Subject ID', 'Gender of the patient']})
